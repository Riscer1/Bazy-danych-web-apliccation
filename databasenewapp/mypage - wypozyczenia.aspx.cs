...
public partial class mypage : System.Web.UI.Page
{
    ...
    {
        {
            ...
            sb1.Append("select Wypozyczenie.idWypozyczenie,Wypozyczenie.idPlacowka,Wypozyczenie.termidOd,Wypozyczenie.terminDo,Wypozyczenie.IdKlienci,Wypozyczenie.idFilm," +
                "Placowka.Adres,Klienci.Nazwisko,Film.Nazwa from dbo.Wypozyczenie Left Join dbo.Placowka on Placowka.IdPlacowka=Wypozyczenie.idPlacowka left join dbo.Film on Film.IdFilm=Wypozyczenie.IdFilm left join dbo.Klienci on Klienci.IdKlienci=Wypozyczenie.IdKlienci");
            if (strSearch.Length > 0)
            {
                //sb1.AppendFormat(" where LastName like '%{0}%'", strSearch);
                sb1.Append(" where idWypozyczenie like @LIKENAME");
            }
    ...
    {
        Response.Redirect("addwypo.aspx");
    }
}