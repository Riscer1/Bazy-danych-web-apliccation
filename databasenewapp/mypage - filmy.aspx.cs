    ...
    {
        {
            ...
            sb1.Append("select Film.idFilm, Kategoria.Gatunek, Film.Nazwa from Film LEFT JOIN Kategoria on Film.idKategoria = Kategoria.idKategoria ");
            if (strSearch.Length > 0)
            {
                //sb1.AppendFormat(" where LastName like '%{0}%'", strSearch);
                sb1.Append(" where Nazwa like @LIKENAME");
            }
